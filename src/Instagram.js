      ...
      <div className='instagram_container'>
        ...
        <div className="instagram_section">
          <button  type="submit" className="instagram_login" onClick={inputsubmit}>
              <a href="https://reactstories.blogspot.com/" className="login_link"> Login</a> </button>
        </div>
        ...
        <div className="instagram_footer">
         ...
         <a href="https://www.instagram.com/accounts/emailsignup/" className="instagram_signup"> Sign up.</a>
          </div>
